...
#form11 .input_tel { border:none; border-bottom:1px solid #ccc; width:80px; padding:3px; height:30px; }
...
<? } ?>			 -->
				...
				<table id="form11" style="width:80%; margin:0 auto; margin-top:100px">


				<? if($is_admin) {?>
				<tr>
				<td class="head"><div style="position:absolute; top:15px; left:0px; color:#cc0000">*</div>
Reservation<br><font color="#888888">예약상태</font></td>
				<td>
					<select name="wr_8">
						<option value="" selected>선택</option>
						<option value="가능" <?=($write['wr_8'] == "가능")?'selected':'';?>>예약접수</option>
						<option value="진행" <?=($write['wr_8'] == "진행")?'selected':'';?>>예약변경</option>
						<option value="선금" <?=($write['wr_8'] == "선금")?'selected':'';?>>예약취소</option>
						<option value="잔금" <?=($write['wr_8'] == "잔금")?'selected':'';?>>예약완료</option>
				...
				<tr>
				<td class="head"><div style="position:absolute; top:15px; left:0px; color:#cc0000">*</div>희망 Doctor</td>
				<td>
					<select name="wr_9" id="room">
						<option value="" selected>선택</option>
						<option value="Spring" <?=($write['wr_9'] == "Spring")?'selected':'';?>>Dr.김영훈</option>
						<option value="Summer" <?=($write['wr_9'] == "Summer")?'selected':'';?>>Dr.박상영</option>
						<option value="Autumn" <?=($write['wr_9'] == "Autumn")?'selected':'';?>>Dr.박의정</option>
						<option value="Winter" <?=($write['wr_9'] == "Winter")?'selected':'';?>>Dr.박수경</option>
						<option value="four seasons" <?=($write['wr_9'] == "four seasons")?'selected':'';?>>상관없음</option>
					</select>
				</td>
				</tr>
				...
				<tr>
				<td class="head"><div style="position:absolute; top:15px; left:0px; color:#cc0000">*</div>희망날짜<br><font color="#888888">희망방문일</font></td>
				<td>
				...
				<td>
					<input class="input" name="wr_name" type="text" id="name" value="<?=$write['wr_name']?>"> <input type="checkbox" name="cc" onClick="showHide(this);"> 예약자명과 환자명이 다릅니다.<br>
				</td>
				</tr>
				<? if($w == '') { ?>
				<tr id="layer" style="display:none;">
					<td class="head"></td>
					<td>환자명 : <input class="input3" name="wr_11" type="text" value="<?=$write['wr_11']?>"> / 환자연락처 : <input class="input3" name="wr_12" type="text" value="<?=$write['wr_12']?>">
				</tr>
				<? } else if($w == 'u') { ?>
				<tr id="layer">
					<td class="head"></td>
...
?>
				...
				<div class="btn" style="margin-bottom:64px">
